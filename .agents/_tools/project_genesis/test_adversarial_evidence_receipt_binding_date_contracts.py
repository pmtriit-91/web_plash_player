#!/usr/bin/env python3
"""Focused Project Genesis adversarial evidence, receipt, binding, and date contracts."""
...
SLICE_STOP = 30
CASE_IDS = (
    "fabricated-off-repo-evidence",
    "symlink-evidence-escape",
    "confirmation-receipt-missing",
    "confirmation-receipt-tampered",
    "confirmation-receipt-wrong-project",
    "confirmation-ledger-symlink",
    "inline-confirmation-forgery",
    "fake-binding-evidence",
    "binding-evidence-drift",
    "impossible-date",
)
CASE_IDS_SHA256 = "60e320e1d7c9185f2556098b73098097747599f7c6008510a049fcc3d68ae29f"
